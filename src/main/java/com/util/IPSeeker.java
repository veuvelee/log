...
/**
 * 定义具体的ip解析的类，最终调用IpUtil类(父类)
 * 解析ip最终的返回时：国家名称 省份名称 城市名称
 *	国外的ip为unknown unknown unknown
 * 	国内ip没法解析，为中国 unknown unknown
 *
 */
public class IPSeeker extends IPUtil {
	 ...
	 * 如果该ip解析失败，那么直接返回默认值
	 * 
	 *  ip:要解析的ip地址，格式为: 120.197.87.216
	 */
	...
	public static class RegionInfo {
		public static final String DEFAULT_VALUE = GlobalEnum.DEFAULT_VALUE; // 默认值
