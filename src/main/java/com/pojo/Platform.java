...
public class Platform extends Base {
	...
	public static List<Platform> buildList(String platformName) {
		if (StringUtils.isBlank(platformName)) {
			platformName = GlobalEnum.DEFAULT_VALUE;
		}
		List<Platform> list = new ArrayList<Platform>();
		list.add(new Platform(GlobalEnum.VALUE_OF_ALL));
		list.add(new Platform(platformName));
		return list;
	}
